// Port do engine My_Blog_Makes_Neil_Proud. Capa opcional — desligada no profile
// desta instalação (imageGenerationEnabled: false) enquanto não houver OPENAI_API_KEY.
